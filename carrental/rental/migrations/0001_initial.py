    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity_document_type', models.CharField(choices=[('dowod', 'dowod osobisty'), ('paszport', 'paszport'), ('prawo_jazdy', 'prawo jazdy')], max_length=20)),
                ('identity_document_no', models.CharField(max_length=20)),
                ('address', models.OneToOneField(on_delete=django.db.models.deletion.RESTRICT, to='rental.adress')),
            ],
            options={
                'verbose_name': 'user',
